...
void parsear_y_repartir_parametros(int argc, char *argv[], int cant_clis)
{
    ...
    for(nro_cli = 0; nro_cli < cant_clis; ++nro_cli) {
        ...
        if(argc > 0) {
            ...
            //~ pcli.cant_iteraciones = (rand() % 18)+3; //pbase.cant_iteraciones/* * n*/;		// tocada
            //~ pcli.mseg_computo_previo = (rand() % 651)+50; //pbase.mseg_computo_previo/* * n*/;		// tocada
            //~ pcli.mseg_seccion_critica = (rand() % 476)+25; //pbase.mseg_seccion_critica/* * n*/;		// tocada
            pcli.cant_iteraciones = pbase.cant_iteraciones/* * n*/;		// tocada
            pcli.mseg_computo_previo = pbase.mseg_computo_previo/* * n*/;		// tocada
            pcli.mseg_seccion_critica = pbase.mseg_seccion_critica/* * n*/;		// tocada
            // cosas agregadas
			//~ pbase.cant_iteraciones--;
			//~ pbase.mseg_computo_previo -= 25;
			//~ pbase.mseg_seccion_critica -= 10;
        }
